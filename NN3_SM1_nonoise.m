...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM1_InOut
...
SM1_net = net;
save ./files_mat_networks/SM1_mn_net;
...
print -dpng ./figures/figure_mn_NN3_SM1_LM
...
% RESULTS
% Width Errors (nm): 0.0028281 0.2778 1.1325
% Height Errors (nm): 0.0083587 0.23233 1.0018
    % 0.2778    1.1325    1.0000    1.0000
    % 0.2323    1.0018    0.9999    1.0000

save ./files_mat_results/results_mn_NN3_SM1