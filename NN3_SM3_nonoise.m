...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM3_InOut
...
SM3_net = net;
save ./files_mat_networks/SM3_mn_net;
...
print -dpng ./figures/figure_mn_NN3_SM3_LM
...
% RESULTS
% Width Errors (nm): 0.00015893 0.25884 1.0484
% Height Errors (nm): 0.00018503 0.26429 0.85331
%     0.2588    1.0484    1.0000    1.0000
%     0.2643    0.8533    0.9999         0
    
save ./files_mat_results/results_mn_NN3_SM3