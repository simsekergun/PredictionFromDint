...
rng(2);
% 0.6482   12.8254    0.9987    4.0000
% 0.4375    6.9231    0.9986    3.0000
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM1_200_InOut
...
SM1_net = net;
save ./files_mat_networks/SM1_mn_200_net;
...
% RESULTS
save ./files_mat_results/results_mn_NN3_SM1_200
...
print -dpng ./figures/figure_mn_NN3_SM1_200_LM
