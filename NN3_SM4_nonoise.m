...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM4_InOut
...
SM4_net = net;
save ./files_mat_networks/SM4_mn_net;
...
print -dpng ./figures/figure_mn_NN3_SM4_LM
...
% RESULTS
% Width Errors (nm): 0.0020572 0.26438 1.1079
% Height Errors (nm): 0.0057913 0.27423 0.7385
%     0.2644    1.1079    1.0000    1.0000
%     0.2742    0.7385    0.9999         0

save ./files_mat_results/results_mn_NN3_SM4