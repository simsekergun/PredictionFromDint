clear;
% RESULTS
% Width Errors (nm): 0.00054905 0.35904 1.3462
% Height Errors (nm): 0.020085 0.38204 2.2195
%     0.3590    1.3462    0.9999    2.0000
%     0.3820    2.2195    0.9997    4.0000
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM3_50_InOut
...
SM3_net = net;
save ./files_mat_networks/SM3_mn_50_net;
...
save ./files_mat_results/results_mn_NN3_SM3_50
...
print -dpng ./figures/figure_mn_NN3_SM3_50_LM
