clear;
% Width Errors (nm): 0.023846 0.39819 2.4931
% Height Errors (nm): 0.0034746 0.23895 2.2044
    % 0.3982    2.4931    0.9998    5.0000
    % 0.2389    2.2044    0.9998    2.0000
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM3_200_InOut
...
SM3_net = net;
save ./files_mat_networks/SM3_mn_200_net;
...
save ./files_mat_results/results_mn_NN3_SM3_200
...
print -dpng ./figures/figure_mn_NN3_SM3_200_LM
