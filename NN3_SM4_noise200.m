clear;
% RESULTS 
    % 0.4384    2.1920    0.9999    5.0000
    % 0.2009    1.2567    0.9999    1.0000
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM4_200_InOut
...
SM4_net = net;
save ./files_mat_networks/SM4_mn_200_net;
...
save ./files_mat_results/results_mn_NN3_SM4_200
...
print -dpng ./figures/figure_mn_NN3_SM4_200_LM
