...
% RESULTS
    % 0.3586    1.8387    0.9999    3.0000
    % 
    % 0.2162    0.8905    0.9999         0
...
hiddenLayerSize = 20;  % tune this later, if needed
...
SM1_net = net;
save ./files_mat_networks/SM1_mn_50_net;
...
save ./files_mat_results/results_mn_NN3_SM1_50
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM1_50_InOut
...
print -dpng ./figures/figure_mn_NN3_SM1_50_LM
