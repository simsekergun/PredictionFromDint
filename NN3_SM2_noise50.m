clear;
   % 0.1792    0.8979    1.0000         0
   %  0.1806    1.1320    0.9999    2.0000
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM2_50_InOut
...
SM2_net = net;
save ./files_mat_networks/SM2_mn_50_net;
...
save ./files_mat_results/results_mn_NN3_SM2_50
...
print -dpng ./figures/figure_mn_NN3_SM2_50_LM
