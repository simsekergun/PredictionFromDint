clear;
% RESULTS
    % 0.3479    1.2077    0.9999    2.0000
    % 0.1979    1.0503    0.9999    1.0000
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM4_50_InOut

% Create and configure the feedforward neural network
hiddenLayerSize = 20;  % tune this if needed
...
SM4_net = net;
save ./files_mat_networks/SM4_mn_50_net;
...
save ./files_mat_results/results_mn_NN3_SM4_50
...
print -dpng ./figures/figure_mn_NN3_SM4_50_LM
