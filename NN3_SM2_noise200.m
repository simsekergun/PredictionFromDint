clear;
% RESULTS
% Width Errors (nm): 0.018599 0.67854 10.6266
% Height Errors (nm): 0.0099699 0.41453 5.9521
%     0.6785   10.6266    0.9991    5.0000
%     0.4145    5.9521    0.9989    3.0000
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('Normalized Height');
title('Test Y')
print -dpng ./figures/figure_mn_SM2_200_InOut
...
SM2_net = net;
save ./files_mat_networks/SM2_mn_200_net;
...
save ./files_mat_results/results_mn_NN3_SM2_200
...
print -dpng ./figures/figure_mn_NN3_SM2_200_LM
